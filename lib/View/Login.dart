...
class _LoginState extends State<Login> {
          ...
          if (value != null && value.cnpj != null)
            {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => EnterpriseView(viewModel)))
            }
          else
            {showAlertDialog1(context)}
        });
  ...
  void _buttonFavoriteAction() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => PreferedList(PreferedViewModel())));
  }
  ...
  showAlertDialog1(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text("Ops"),
      content: Text(
          "Parece que houve algum problema, confira o cnpj inserido e tente novamente em alguns segundos."),
      actions: [
        okButton,
      ],
    );
  ...
  Widget handlerFavoritebutton() {
    ...
    if (enable) {
      return Padding(
        padding: EdgeInsets.only(top: 16, left: 0, right: 8),
        child: SizedBox(
          width: 288,
          height: 48,
          child: RaisedButton(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Row(children: [
                          Expanded(child: handlerFavoritebutton()),
                          Expanded(
                            child: Padding(
                              padding: EdgeInsets.only(top: 16),
                              child: SizedBox(
